...
const Toolrailsubitems = ({ State }: {
  ...
  if (State === 'Hover with expand arrow') return <Statehoverwithexpandarrow3924109166 />;
  return <Stateactive10816468 />;
};

const meta = {
  title: '3. Component Category Pages/Tool Rail/Tool rail / sub items',
  ...
  parameters: {
    ...
    figma: {
      ...
      figmaComponent: 'Tool rail / sub items',
    },
  },
  tags: ['autodocs'],
  argTypes: {
