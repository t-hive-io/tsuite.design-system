...
const Toolrailexpandmenu = ({ Property1 }: {
  Property1?: 'Manual operation menu' | 'Storage menu' | 'Process';
} = {
    Property1: 'Storage menu'
  }) => {
  if (Property1 === 'Manual operation menu') return <Property1manualoperationmenu533819518 />;
...
const meta = {
  title: '3. Component Category Pages/Tool Rail/Tool rail expand menu',
