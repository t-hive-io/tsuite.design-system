...
const LoadingBar = ({ Position }: {
  ...
  if (Position === '4') return <Position115549448 />;
  if (Position === '5') return <Position115549448 />;
  return <Position115549448 />;
};

const meta = {
  title: '3. Component Category Pages/Progress Indicators/Loading Bar',
