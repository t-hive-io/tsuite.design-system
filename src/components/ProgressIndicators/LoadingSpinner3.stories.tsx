...
const LoadingSpinner3 = ({ Position }: {
  Position?: '1' | '2' | '3' | '4';
} = {
    Position: '1'
  }) => {
  ...
  if (Position === '4') return <Position115549409 />;
  return <Position115549409 />;
};

const meta = {
  title: '3. Component Category Pages/Progress Indicators/Loading Spinner 3',
  ...
  parameters: {
    ...
    figma: {
      ...
      figmaComponent: 'Loading Spinner 3',
    },
  },
  tags: ['autodocs'],
  argTypes: {
