...
const Rack = ({ Property1 }: {
  Property1?: 'Beam height' | 'Defaul racking' | 'First shelf height' | 'Gap between loads' | 'Number of cells (depth)' | 'Post width' | 'Side margin racking' | 'Top margin' | 'Total level depth';
} = {
    Property1: 'Defaul racking'
  }) => {
  if (Property1 === 'Beam height') return <Property1beamheight457337788 />;
  if (Property1 === 'Defaul racking') return <Property1defaulracking457337785 />;
  if (Property1 === 'First shelf height') return <Property1firstshelfheight457337790 />;
  if (Property1 === 'Gap between loads') return <Property1gapbetweenloads457337786 />;
  if (Property1 === 'Number of cells (depth)') return <Property1numberofcellsdepth460742525 />;
  if (Property1 === 'Post width') return <Property1postwidth457337789 />;
  if (Property1 === 'Side margin racking') return <Property1sidemarginracking457337784 />;
  if (Property1 === 'Top margin') return <Property1topmargin457337787 />;
  if (Property1 === 'Total level depth') return <Property1totalleveldepth460742524 />;
  return <Property1beamheight457337788 />;
};

const meta = {
  title: '3. Component Category Pages/Illustrations/Rack',
  component: Rack,
  parameters: {
    layout: 'centered',
    figma: {
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Beam height', 'Defaul racking', 'First shelf height', 'Gap between loads', 'Number of cells (depth)', 'Post width', 'Side margin racking', 'Top margin', 'Total level depth'],
