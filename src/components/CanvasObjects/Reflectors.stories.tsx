...
const Reflectors = ({ Property1 }: {
  Property1?: 'Reflector right' | 'Reflector center' | 'Reflector cylinder' | 'Reflector left';
} = {
    Property1: 'Reflector left'
  }) => {
  if (Property1 === 'Reflector right') return <Property1reflectorright30549776 />;
  if (Property1 === 'Reflector center') return <Property1reflectorcenter30549777 />;
  if (Property1 === 'Reflector cylinder') return <Property1reflectorcylinder30549774 />;
  if (Property1 === 'Reflector left') return <Property1reflectorleft30549775 />;
  return <Property1reflectorcenter30549777 />;
};

const meta = {
  title: '3. Component Category Pages/Canvas Objects/Reflectors',
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Reflector right', 'Reflector center', 'Reflector cylinder', 'Reflector left'],
