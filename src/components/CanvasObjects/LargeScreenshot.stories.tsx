...
const LargeScreenshot = ({ Property1 }: {
  Property1?: 'Angled highway' | 'Ref img' | '3D' | '3D top view' | 'System Upload file';
} = {
    Property1: '3D'
  }) => {
  ...
  if (Property1 === 'System Upload file') return <Property1systemuploadfile31831572 />;
  return <Property13d31811335 />;
};

const meta = {
  title: '3. Component Category Pages/Canvas Objects/Large Screenshot',
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Angled highway', 'Ref img', '3D', '3D top view', 'System Upload file'],
