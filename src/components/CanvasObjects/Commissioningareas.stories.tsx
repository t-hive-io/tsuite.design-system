...
const Commissioningareas = ({ Property1 }: {
  Property1?: 'Com_Intake_center' | 'Com_Intake_top' | 'Com_Intake_bottom' | 'Com_Delivery_center' | 'Com_Delivery_top' | 'Com_Delivery_bottom' | 'Com_Process_center' | 'Com_Process_bottom' | 'Com_Process_top' | 'Com_Storage_center' | 'Com_Storage_bottom' | 'Com_Storage_top' | 'Com_Charging_center' | 'Com_Charging_bottom' | 'Com_Charging_top' | 'Com_Parking_top' | 'Com_Parking_center' | 'Com_Parking_bottom';
} = {
    Property1: 'Com_Intake_center'
  }) => {
  if (Property1 === 'Com_Intake_center') return <Property1comIntakeCenter2924861 />;
  if (Property1 === 'Com_Intake_top') return <Property1comIntakeTop2924863 />;
  if (Property1 === 'Com_Intake_bottom') return <Property1comIntakeBottom2924913 />;
  if (Property1 === 'Com_Delivery_center') return <Property1comDeliveryCenter2924963 />;
  if (Property1 === 'Com_Delivery_top') return <Property1comDeliveryTop29241013 />;
  if (Property1 === 'Com_Delivery_bottom') return <Property1comDeliveryBottom29241063 />;
  if (Property1 === 'Com_Process_center') return <Property1comProcessCenter29251199 />;
  if (Property1 === 'Com_Process_bottom') return <Property1comProcessBottom29251249 />;
  if (Property1 === 'Com_Process_top') return <Property1comProcessTop29251299 />;
  if (Property1 === 'Com_Storage_center') return <Property1comStorageCenter29251353 />;
  if (Property1 === 'Com_Storage_bottom') return <Property1comStorageBottom29251503 />;
  if (Property1 === 'Com_Storage_top') return <Property1comStorageTop29251553 />;
  if (Property1 === 'Com_Charging_center') return <Property1comChargingCenter2945908 />;
  if (Property1 === 'Com_Charging_bottom') return <Property1comChargingBottom2945958 />;
  if (Property1 === 'Com_Charging_top') return <Property1comChargingTop29451008 />;
  if (Property1 === 'Com_Parking_top') return <Property1comParkingTop29451110 />;
  if (Property1 === 'Com_Parking_center') return <Property1comParkingCenter29451060 />;
  if (Property1 === 'Com_Parking_bottom') return <Property1comParkingBottom29451160 />;
  return <Property1comChargingBottom2945958 />;
};

const meta = {
  title: '3. Component Category Pages/Canvas Objects/Commissioning areas',
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Com_Intake_center', 'Com_Intake_top', 'Com_Intake_bottom', 'Com_Delivery_center', 'Com_Delivery_top', 'Com_Delivery_bottom', 'Com_Process_center', 'Com_Process_bottom', 'Com_Process_top', 'Com_Storage_center', 'Com_Storage_bottom', 'Com_Storage_top', 'Com_Charging_center', 'Com_Charging_bottom', 'Com_Charging_top', 'Com_Parking_top', 'Com_Parking_center', 'Com_Parking_bottom'],
