...
const Flowcolormodal = ({ Property1 }: {
  Property1?: 'Default' | 'Selected outline';
} = {
    Property1: 'Default'
  }) => {
  if (Property1 === 'Default') return <Property1default30932879 />;
  if (Property1 === 'Selected outline') return <Property1selectedoutline30932938 />;
  return <Property1default30932879 />;
};

const meta = {
  title: '3. Component Category Pages/Canvas Objects/Flow color modal',
