...
const Referenceimage = ({ Property1 }: {
  Property1?: 'Default' | 'Upload file' | 'File uploaded' | 'Reflector map uploaded';
} = {
    Property1: 'Default'
  }) => {
  ...
  if (Property1 === 'Reflector map uploaded') return <Property1reflectormapuploaded30289648 />;
  return <Property1default29922812 />;
};

const meta = {
  title: '3. Component Category Pages/U I Shell Right Panel/Reference image',
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Default', 'Upload file', 'File uploaded', 'Reflector map uploaded'],
