...
const Rightbarinputrow = ({ Type }: {
  Type?: '1 Label + 2 controls' | 'Label + controls' | '2 labels + control + icon' | 'Label + switch' | '2 labels + control + input' | '2 Label + 2 controls' | 'Right bar - segment';
} = {
  ...
  if (Type === '2 labels + control + icon') return <Type2labelscontrolicon15439351 />;
  if (Type === 'Label + switch') return <Typelabelswitch18948831 />;
  if (Type === '2 labels + control + input') return <Type2labelscontrolinput19247941 />;
...
const meta = {
  title: '3. Component Category Pages/U I Shell Right Panel/Right bar - input row',
  ...
  argTypes: {
    Type: {
      control: 'select',
      options: ['1 Label + 2 controls', 'Label + controls', '2 labels + control + icon', 'Label + switch', '2 labels + control + input', '2 Label + 2 controls', 'Right bar - segment'],
