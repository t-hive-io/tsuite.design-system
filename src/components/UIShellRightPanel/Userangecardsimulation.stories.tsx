...
const Userangecardsimulation = ({ Property1 }: {
  Property1?: 'Use range active' | 'Use range deactive';
} = {
    Property1: 'Use range deactive'
  }) => {
  if (Property1 === 'Use range active') return <Property1userangeactive526422952 />;
  if (Property1 === 'Use range deactive') return <Property1userangedeactive526422953 />;
  return <Property1userangeactive526422952 />;
};

const meta = {
  title: '3. Component Category Pages/U I Shell Right Panel/Use range card (simulation)',
