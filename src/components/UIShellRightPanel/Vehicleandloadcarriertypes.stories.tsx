...
const Vehicleandloadcarriertypes = ({ Property1 }: {
  ...
  if (Property1 === 'Load carrier types') return <Property1loadcarriertypes29922872 />;
  return <Property1loadcarriertypes29922872 />;
};

const meta = {
  title: '3. Component Category Pages/U I Shell Right Panel/Vehicle and load carrier types',
