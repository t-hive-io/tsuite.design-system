...
import Property1highway29964407 from '../../assets/icons/Property1highway--2996-4407.svg?react';
...
const Areasections = ({ Property1 }: {
  Property1?: 'Template area sections' | 'Chargin Parking' | 'Obstacle' | 'Angled Highway' | 'Highway' | 'Wall' | 'Process 1' | 'Commissioning' | 'Intake Storage Delivery' | 'Manual process area section' | 'Hand-over on off vehicle' | 'Entry/Exit' | 'Decision point' | 'Process 2';
} = {
    Property1: 'Intake Storage Delivery'
  }) => {
  if (Property1 === 'Template area sections') return <Property1templateareasections434641924 />;
  if (Property1 === 'Chargin Parking') return <Property1charginparking29962707 />;
  ...
  if (Property1 === 'Intake Storage Delivery') return <Property1intakestoragedelivery29952288 />;
  if (Property1 === 'Manual process area section') return <Property1manualprocessareasection536226854 />;
  if (Property1 === 'Hand-over on off vehicle') return <Property1handOveronoffvehicle3859104882 />;
  if (Property1 === 'Decision point') return <Property1decisionpoint536724597 />;
  if (Property1 === 'Process 2') return <Property1process2538353677 />;
  return <Property1angledhighway29964684 />;
};

const meta = {
  title: '3. Component Category Pages/U I Shell Right Panel/Area sections',
  ...
  argTypes: {
    Property1: {
      control: 'select',
      options: ['Template area sections', 'Chargin Parking', 'Obstacle', 'Angled Highway', 'Highway', 'Wall', 'Process 1', 'Commissioning', 'Intake Storage Delivery', 'Manual process area section', 'Hand-over on off vehicle', 'Entry/Exit', 'Decision point', 'Process 2'],
