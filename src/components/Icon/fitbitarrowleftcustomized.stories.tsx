...
const Fitbitarrowleftcustomized = ({ Property1 }: {
...
const meta = {
  title: '3. Component Category Pages/Icon/fitbit_arrow_left_customized',
  ...
  parameters: {
    ...
    figma: {
      ...
      figmaComponent: 'fitbit_arrow_left_customized',
    },
  },
  tags: ['autodocs'],
  argTypes: {
