...
const meta = {
  title: 'Components/Icons/keyboard_double_arrow_right_left',
  ...
  parameters: {
    ...
    figma: {
      ...
      url: 'https://www.figma.com/design/XKxVlFf9TfWBHosOInkJXA/T-Suite-Design-System?node-id=3838-102827',
    },
  },
  tags: ['autodocs'],
  argTypes: {
