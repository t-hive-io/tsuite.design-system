 ...
 */
export const Property1level2foldedstatefocused: React.FC<Property1level2foldedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level2foldedstatefocused ${className || ''}`} />;
};
