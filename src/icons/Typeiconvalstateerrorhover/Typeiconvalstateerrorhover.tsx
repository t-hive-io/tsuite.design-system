 ...
 */
export const Typeiconvalstateerrorhover: React.FC<TypeiconvalstateerrorhoverProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalstateerrorhover ${className || ''}`} />;
};
