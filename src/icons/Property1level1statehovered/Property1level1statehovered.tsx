 ...
 */
export const Property1level1statehovered: React.FC<Property1level1statehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level1statehovered ${className || ''}`} />;
};
