 ...
 */
export const Property1level3stateenabled: React.FC<Property1level3stateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level3stateenabled ${className || ''}`} />;
};
