 ...
 */
export const Property1level4statefocused: React.FC<Property1level4statefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level4statefocused ${className || ''}`} />;
};
