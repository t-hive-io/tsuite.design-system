 ...
 */
export const Lockedtruehoverfalsehidefalse: React.FC<LockedtruehoverfalsehidefalseProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehoverfalsehidefalse ${className || ''}`} />;
};
