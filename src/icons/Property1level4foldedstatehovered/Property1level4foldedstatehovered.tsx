 ...
 */
export const Property1level4foldedstatehovered: React.FC<Property1level4foldedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level4foldedstatehovered ${className || ''}`} />;
};
