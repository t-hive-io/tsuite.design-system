 ...
 */
export const Property1horizontalgapbetweenvehicles: React.FC<Property1horizontalgapbetweenvehiclesProps> = ({ className }) => {
  return <IconSvg className={`property1horizontalgapbetweenvehicles ${className || ''}`} />;
};
