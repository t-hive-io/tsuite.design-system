 ...
 */
export const Lockedtruehovertruehidetrueaddopacity: React.FC<LockedtruehovertruehidetrueaddopacityProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehovertruehidetrueaddopacity ${className || ''}`} />;
};
