 ...
 */
export const Property1comChargingCenter: React.FC<Property1comChargingCenterProps> = ({ className }) => {
  return <IconSvg className={`property1comchargingcenter ${className || ''}`} />;
};
