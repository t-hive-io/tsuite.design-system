 ...
 */
export const Typeprimaryiconnoiconstatedisabled: React.FC<TypeprimaryiconnoiconstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconnoiconstatedisabled ${className || ''}`} />;
};
