 ...
 */
export const Typeprimaryiconnoiconstatefocused: React.FC<TypeprimaryiconnoiconstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconnoiconstatefocused ${className || ''}`} />;
};
