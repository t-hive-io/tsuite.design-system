 ...
 */
export const Typeprimaryiconnoiconstateenabled: React.FC<TypeprimaryiconnoiconstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconnoiconstateenabled ${className || ''}`} />;
};
