 ...
 */
export const Typeprimaryiconnoiconstatepressed: React.FC<TypeprimaryiconnoiconstatepressedProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconnoiconstatepressed ${className || ''}`} />;
};
