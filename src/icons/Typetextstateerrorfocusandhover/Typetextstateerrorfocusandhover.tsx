 ...
 */
export const Typetextstateerrorfocusandhover: React.FC<TypetextstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typetextstateerrorfocusandhover ${className || ''}`} />;
};
