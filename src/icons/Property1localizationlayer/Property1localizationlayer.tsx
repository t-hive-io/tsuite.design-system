 ...
 */
export const Property1localizationlayer: React.FC<Property1localizationlayerProps> = ({ className }) => {
  return <IconSvg className={`property1localizationlayer ${className || ''}`} />;
};
