 ...
 */
export const Typevaliconstateerrorhover: React.FC<TypevaliconstateerrorhoverProps> = ({ className }) => {
  return <IconSvg className={`typevaliconstateerrorhover ${className || ''}`} />;
};
