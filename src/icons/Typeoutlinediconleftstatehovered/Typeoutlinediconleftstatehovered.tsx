 ...
 */
export const Typeoutlinediconleftstatehovered: React.FC<TypeoutlinediconleftstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconleftstatehovered ${className || ''}`} />;
};
