 ...
 */
export const Typeprimaryiconleftstatepressed: React.FC<TypeprimaryiconleftstatepressedProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconleftstatepressed ${className || ''}`} />;
};
