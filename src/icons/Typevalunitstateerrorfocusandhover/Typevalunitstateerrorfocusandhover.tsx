 ...
 */
export const Typevalunitstateerrorfocusandhover: React.FC<TypevalunitstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typevalunitstateerrorfocusandhover ${className || ''}`} />;
};
