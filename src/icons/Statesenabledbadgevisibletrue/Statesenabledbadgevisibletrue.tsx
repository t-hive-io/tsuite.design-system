 ...
 */
export const Statesenabledbadgevisibletrue: React.FC<StatesenabledbadgevisibletrueProps> = ({ className }) => {
  return <IconSvg className={`statesenabledbadgevisibletrue ${className || ''}`} />;
};
