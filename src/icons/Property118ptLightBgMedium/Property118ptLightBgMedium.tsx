 ...
 */
export const Property118ptLightBgMedium: React.FC<Property118ptLightBgMediumProps> = ({ className }) => {
  return <IconSvg className={`property118ptlightbgmedium ${className || ''}`} />;
};
