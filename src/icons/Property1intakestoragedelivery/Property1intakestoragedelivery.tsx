 ...
 */
export const Property1intakestoragedelivery: React.FC<Property1intakestoragedeliveryProps> = ({ className }) => {
  return <IconSvg className={`property1intakestoragedelivery ${className || ''}`} />;
};
