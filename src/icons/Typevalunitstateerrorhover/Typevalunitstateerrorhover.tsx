 ...
 */
export const Typevalunitstateerrorhover: React.FC<TypevalunitstateerrorhoverProps> = ({ className }) => {
  return <IconSvg className={`typevalunitstateerrorhover ${className || ''}`} />;
};
