 ...
 */
export const Arrowtopleftshortcutkeylighttrue: React.FC<ArrowtopleftshortcutkeylighttrueProps> = ({ className }) => {
  return <IconSvg className={`arrowtopleftshortcutkeylighttrue ${className || ''}`} />;
};
