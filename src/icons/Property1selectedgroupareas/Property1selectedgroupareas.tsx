 ...
 */
export const Property1selectedgroupareas: React.FC<Property1selectedgroupareasProps> = ({ className }) => {
  return <IconSvg className={`property1selectedgroupareas ${className || ''}`} />;
};
