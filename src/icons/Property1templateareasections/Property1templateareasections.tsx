 ...
 */
export const Property1templateareasections: React.FC<Property1templateareasectionsProps> = ({ className }) => {
  return <IconSvg className={`property1templateareasections ${className || ''}`} />;
};
