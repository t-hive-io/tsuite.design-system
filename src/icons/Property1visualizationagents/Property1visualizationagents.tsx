 ...
 */
export const Property1visualizationagents: React.FC<Property1visualizationagentsProps> = ({ className }) => {
  return <IconSvg className={`property1visualizationagents ${className || ''}`} />;
};
