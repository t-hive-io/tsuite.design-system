 ...
 */
export const Arrowbottomcenterlighttrue: React.FC<ArrowbottomcenterlighttrueProps> = ({ className }) => {
  return <IconSvg className={`arrowbottomcenterlighttrue ${className || ''}`} />;
};
