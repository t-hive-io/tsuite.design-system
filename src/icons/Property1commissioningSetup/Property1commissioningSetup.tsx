 ...
 */
export const Property1commissioningSetup: React.FC<Property1commissioningSetupProps> = ({ className }) => {
  return <IconSvg className={`property1commissioningsetup ${className || ''}`} />;
};
