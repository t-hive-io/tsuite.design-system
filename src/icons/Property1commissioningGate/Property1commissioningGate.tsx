 ...
 */
export const Property1commissioningGate: React.FC<Property1commissioningGateProps> = ({ className }) => {
  return <IconSvg className={`property1commissioninggate ${className || ''}`} />;
};
