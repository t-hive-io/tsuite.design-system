 ...
 */
export const Typeiconvalunitstatedisabled: React.FC<TypeiconvalunitstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstatedisabled ${className || ''}`} />;
};
