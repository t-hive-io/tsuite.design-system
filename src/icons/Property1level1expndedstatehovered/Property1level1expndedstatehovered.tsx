 ...
 */
export const Property1level1expndedstatehovered: React.FC<Property1level1expndedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level1expndedstatehovered ${className || ''}`} />;
};
