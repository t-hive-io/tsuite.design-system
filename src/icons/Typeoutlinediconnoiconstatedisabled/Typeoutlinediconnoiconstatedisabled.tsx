 ...
 */
export const Typeoutlinediconnoiconstatedisabled: React.FC<TypeoutlinediconnoiconstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconnoiconstatedisabled ${className || ''}`} />;
};
