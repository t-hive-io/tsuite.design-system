 ...
 */
export const Typenumberstateerrorenabled: React.FC<TypenumberstateerrorenabledProps> = ({ className }) => {
  return <IconSvg className={`typenumberstateerrorenabled ${className || ''}`} />;
};
