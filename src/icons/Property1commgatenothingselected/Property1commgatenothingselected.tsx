 ...
 */
export const Property1commgatenothingselected: React.FC<Property1commgatenothingselectedProps> = ({ className }) => {
  return <IconSvg className={`property1commgatenothingselected ${className || ''}`} />;
};
