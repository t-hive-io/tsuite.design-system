 ...
 */
export const Property1loadcarrierlabelicon: React.FC<Property1loadcarrierlabeliconProps> = ({ className }) => {
  return <IconSvg className={`property1loadcarrierlabelicon ${className || ''}`} />;
};
