 ...
 */
export const Lockedfalsehoverfalsehidetrue: React.FC<LockedfalsehoverfalsehidetrueProps> = ({ className }) => {
  return <IconSvg className={`lockedfalsehoverfalsehidetrue ${className || ''}`} />;
};
