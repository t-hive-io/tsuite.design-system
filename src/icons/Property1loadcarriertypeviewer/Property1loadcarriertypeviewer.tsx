 ...
 */
export const Property1loadcarriertypeviewer: React.FC<Property1loadcarriertypeviewerProps> = ({ className }) => {
  return <IconSvg className={`property1loadcarriertypeviewer ${className || ''}`} />;
};
