 ...
 */
export const Property1level4foldedstateenabled: React.FC<Property1level4foldedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level4foldedstateenabled ${className || ''}`} />;
};
