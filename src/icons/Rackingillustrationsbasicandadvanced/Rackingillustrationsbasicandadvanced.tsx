 ...
 */
export const Rackingillustrationsbasicandadvanced: React.FC<RackingillustrationsbasicandadvancedProps> = ({ className }) => {
  return <IconSvg className={`rackingillustrationsbasicandadvanced ${className || ''}`} />;
};
