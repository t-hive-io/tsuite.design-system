 ...
 */
export const Typenumberstateerrorfocusandhover: React.FC<TypenumberstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typenumberstateerrorfocusandhover ${className || ''}`} />;
};
