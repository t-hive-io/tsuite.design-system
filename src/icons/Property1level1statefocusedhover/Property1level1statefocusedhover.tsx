 ...
 */
export const Property1level1statefocusedhover: React.FC<Property1level1statefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level1statefocusedhover ${className || ''}`} />;
};
