 ...
 */
export const Property1level3statefocusedhover: React.FC<Property1level3statefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level3statefocusedhover ${className || ''}`} />;
};
