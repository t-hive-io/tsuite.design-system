 ...
 */
export const Horizontaltrueforkliftdown: React.FC<HorizontaltrueforkliftdownProps> = ({ className }) => {
  return <IconSvg className={`horizontaltrueforkliftdown ${className || ''}`} />;
};
