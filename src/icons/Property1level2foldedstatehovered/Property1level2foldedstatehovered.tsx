 ...
 */
export const Property1level2foldedstatehovered: React.FC<Property1level2foldedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level2foldedstatehovered ${className || ''}`} />;
};
