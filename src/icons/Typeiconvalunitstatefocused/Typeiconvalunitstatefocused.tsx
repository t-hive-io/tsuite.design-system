 ...
 */
export const Typeiconvalunitstatefocused: React.FC<TypeiconvalunitstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstatefocused ${className || ''}`} />;
};
