 ...
 */
export const Typerowswithtagselectedselected: React.FC<TyperowswithtagselectedselectedProps> = ({ className }) => {
  return <IconSvg className={`typerowswithtagselectedselected ${className || ''}`} />;
};
