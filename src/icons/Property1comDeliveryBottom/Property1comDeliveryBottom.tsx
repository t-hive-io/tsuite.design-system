 ...
 */
export const Property1comDeliveryBottom: React.FC<Property1comDeliveryBottomProps> = ({ className }) => {
  return <IconSvg className={`property1comdeliverybottom ${className || ''}`} />;
};
