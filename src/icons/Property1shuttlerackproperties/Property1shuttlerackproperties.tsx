 ...
 */
export const Property1shuttlerackproperties: React.FC<Property1shuttlerackpropertiesProps> = ({ className }) => {
  return <IconSvg className={`property1shuttlerackproperties ${className || ''}`} />;
};
