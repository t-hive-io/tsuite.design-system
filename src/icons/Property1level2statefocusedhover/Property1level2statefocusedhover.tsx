 ...
 */
export const Property1level2statefocusedhover: React.FC<Property1level2statefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level2statefocusedhover ${className || ''}`} />;
};
