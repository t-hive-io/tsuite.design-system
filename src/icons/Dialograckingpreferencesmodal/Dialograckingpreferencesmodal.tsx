 ...
 */
export const Dialograckingpreferencesmodal: React.FC<DialograckingpreferencesmodalProps> = ({ className }) => {
  return <IconSvg className={`dialograckingpreferencesmodal ${className || ''}`} />;
};
