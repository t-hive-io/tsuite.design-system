 ...
 */
export const Lockedfalsehovertruehidetrueaddopacity: React.FC<LockedfalsehovertruehidetrueaddopacityProps> = ({ className }) => {
  return <IconSvg className={`lockedfalsehovertruehidetrueaddopacity ${className || ''}`} />;
};
