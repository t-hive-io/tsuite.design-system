 ...
 */
export const Property1level4expandedstatefocused: React.FC<Property1level4expandedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level4expandedstatefocused ${className || ''}`} />;
};
