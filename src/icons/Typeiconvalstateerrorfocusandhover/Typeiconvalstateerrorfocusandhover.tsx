 ...
 */
export const Typeiconvalstateerrorfocusandhover: React.FC<TypeiconvalstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalstateerrorfocusandhover ${className || ''}`} />;
};
