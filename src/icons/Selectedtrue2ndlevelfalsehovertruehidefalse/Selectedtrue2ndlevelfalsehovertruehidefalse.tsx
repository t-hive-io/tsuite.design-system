 ...
 */
export const Selectedtrue2ndlevelfalsehovertruehidefalse: React.FC<Selectedtrue2ndlevelfalsehovertruehidefalseProps> = ({ className }) => {
  return <IconSvg className={`selectedtrue2ndlevelfalsehovertruehidefalse ${className || ''}`} />;
};
