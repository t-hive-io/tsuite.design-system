 ...
 */
export const Property1level3expandedstatefocused: React.FC<Property1level3expandedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level3expandedstatefocused ${className || ''}`} />;
};
