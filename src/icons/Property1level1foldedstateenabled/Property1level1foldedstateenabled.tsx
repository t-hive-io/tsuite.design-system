 ...
 */
export const Property1level1foldedstateenabled: React.FC<Property1level1foldedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level1foldedstateenabled ${className || ''}`} />;
};
