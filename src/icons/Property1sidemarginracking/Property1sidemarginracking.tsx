 ...
 */
export const Property1sidemarginracking: React.FC<Property1sidemarginrackingProps> = ({ className }) => {
  return <IconSvg className={`property1sidemarginracking ${className || ''}`} />;
};
