 ...
 */
export const Property1level1foldedstatefocused: React.FC<Property1level1foldedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level1foldedstatefocused ${className || ''}`} />;
};
