 ...
 */
export const Typeiconvalunitstateerrorhover: React.FC<TypeiconvalunitstateerrorhoverProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstateerrorhover ${className || ''}`} />;
};
