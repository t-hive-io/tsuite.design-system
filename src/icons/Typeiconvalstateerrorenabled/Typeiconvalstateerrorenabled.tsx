 ...
 */
export const Typeiconvalstateerrorenabled: React.FC<TypeiconvalstateerrorenabledProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalstateerrorenabled ${className || ''}`} />;
};
