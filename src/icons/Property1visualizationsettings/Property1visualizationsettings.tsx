 ...
 */
export const Property1visualizationsettings: React.FC<Property1visualizationsettingsProps> = ({ className }) => {
  return <IconSvg className={`property1visualizationsettings ${className || ''}`} />;
};
