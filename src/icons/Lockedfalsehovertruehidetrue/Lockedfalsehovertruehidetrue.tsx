 ...
 */
export const Lockedfalsehovertruehidetrue: React.FC<LockedfalsehovertruehidetrueProps> = ({ className }) => {
  return <IconSvg className={`lockedfalsehovertruehidetrue ${className || ''}`} />;
};
