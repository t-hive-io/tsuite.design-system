 ...
 */
export const Property1simulationruncard: React.FC<Property1simulationruncardProps> = ({ className }) => {
  return <IconSvg className={`property1simulationruncard ${className || ''}`} />;
};
