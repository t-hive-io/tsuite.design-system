 ...
 */
export const Property1numberofcellsdepth: React.FC<Property1numberofcellsdepthProps> = ({ className }) => {
  return <IconSvg className={`property1numberofcellsdepth ${className || ''}`} />;
};
