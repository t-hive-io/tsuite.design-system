 ...
 */
export const Property1level3expandedstatefocusedhover: React.FC<Property1level3expandedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level3expandedstatefocusedhover ${className || ''}`} />;
};
