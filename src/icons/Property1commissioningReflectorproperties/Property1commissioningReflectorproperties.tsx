 ...
 */
export const Property1commissioningReflectorproperties: React.FC<Property1commissioningReflectorpropertiesProps> = ({ className }) => {
  return <IconSvg className={`property1commissioningreflectorproperties ${className || ''}`} />;
};
