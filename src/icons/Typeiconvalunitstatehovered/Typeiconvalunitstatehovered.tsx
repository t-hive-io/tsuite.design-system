 ...
 */
export const Typeiconvalunitstatehovered: React.FC<TypeiconvalunitstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstatehovered ${className || ''}`} />;
};
