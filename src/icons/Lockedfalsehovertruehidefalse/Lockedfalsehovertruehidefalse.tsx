 ...
 */
export const Lockedfalsehovertruehidefalse: React.FC<LockedfalsehovertruehidefalseProps> = ({ className }) => {
  return <IconSvg className={`lockedfalsehovertruehidefalse ${className || ''}`} />;
};
