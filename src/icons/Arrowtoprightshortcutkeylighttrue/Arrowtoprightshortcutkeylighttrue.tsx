 ...
 */
export const Arrowtoprightshortcutkeylighttrue: React.FC<ArrowtoprightshortcutkeylighttrueProps> = ({ className }) => {
  return <IconSvg className={`arrowtoprightshortcutkeylighttrue ${className || ''}`} />;
};
