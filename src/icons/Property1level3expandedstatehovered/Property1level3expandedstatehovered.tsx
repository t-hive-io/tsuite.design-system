 ...
 */
export const Property1level3expandedstatehovered: React.FC<Property1level3expandedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level3expandedstatehovered ${className || ''}`} />;
};
