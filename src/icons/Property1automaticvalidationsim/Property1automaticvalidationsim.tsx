 ...
 */
export const Property1automaticvalidationsim: React.FC<Property1automaticvalidationsimProps> = ({ className }) => {
  return <IconSvg className={`property1automaticvalidationsim ${className || ''}`} />;
};
