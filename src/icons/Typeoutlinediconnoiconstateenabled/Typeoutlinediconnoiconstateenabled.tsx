 ...
 */
export const Typeoutlinediconnoiconstateenabled: React.FC<TypeoutlinediconnoiconstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconnoiconstateenabled ${className || ''}`} />;
};
