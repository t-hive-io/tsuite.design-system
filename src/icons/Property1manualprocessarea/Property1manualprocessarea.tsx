 ...
 */
export const Property1manualprocessarea: React.FC<Property1manualprocessareaProps> = ({ className }) => {
  return <IconSvg className={`property1manualprocessarea ${className || ''}`} />;
};
