 ...
 */
export const PropertypanelSetuplayoutsimulation3dvisualiationcommissioning: React.FC<PropertypanelSetuplayoutsimulation3dvisualiationcommissioningProps> = ({ className }) => {
  return <IconSvg className={`propertypanelsetuplayoutsimulation3dvisualiationcommissioning ${className || ''}`} />;
};
