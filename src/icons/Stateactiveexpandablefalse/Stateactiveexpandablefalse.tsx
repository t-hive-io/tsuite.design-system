 ...
 */
export const Stateactiveexpandablefalse: React.FC<StateactiveexpandablefalseProps> = ({ className }) => {
  return <IconSvg className={`stateactiveexpandablefalse ${className || ''}`} />;
};
