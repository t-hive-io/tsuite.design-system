 ...
 */
export const Property1intakeareaAllcollapsed: React.FC<Property1intakeareaAllcollapsedProps> = ({ className }) => {
  return <IconSvg className={`property1intakeareaallcollapsed ${className || ''}`} />;
};
