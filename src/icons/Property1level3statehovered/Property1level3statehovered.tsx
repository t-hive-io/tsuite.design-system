 ...
 */
export const Property1level3statehovered: React.FC<Property1level3statehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level3statehovered ${className || ''}`} />;
};
