 ...
 */
export const Lockedfalsehovertruehidefalseaddopacity: React.FC<LockedfalsehovertruehidefalseaddopacityProps> = ({ className }) => {
  return <IconSvg className={`lockedfalsehovertruehidefalseaddopacity ${className || ''}`} />;
};
