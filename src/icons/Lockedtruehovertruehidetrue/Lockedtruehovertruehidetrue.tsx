 ...
 */
export const Lockedtruehovertruehidetrue: React.FC<LockedtruehovertruehidetrueProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehovertruehidetrue ${className || ''}`} />;
};
