 ...
 */
export const Statesenabledbadgevisiblefalse: React.FC<StatesenabledbadgevisiblefalseProps> = ({ className }) => {
  return <IconSvg className={`statesenabledbadgevisiblefalse ${className || ''}`} />;
};
