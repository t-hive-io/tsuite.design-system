 ...
 */
export const Property1dimensionletterandicon: React.FC<Property1dimensionletterandiconProps> = ({ className }) => {
  return <IconSvg className={`property1dimensionletterandicon ${className || ''}`} />;
};
