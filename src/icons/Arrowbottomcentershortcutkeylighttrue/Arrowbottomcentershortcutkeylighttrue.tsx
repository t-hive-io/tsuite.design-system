 ...
 */
export const Arrowbottomcentershortcutkeylighttrue: React.FC<ArrowbottomcentershortcutkeylighttrueProps> = ({ className }) => {
  return <IconSvg className={`arrowbottomcentershortcutkeylighttrue ${className || ''}`} />;
};
