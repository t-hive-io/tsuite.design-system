 ...
 */
export const Typevaliconstateerrorenabled: React.FC<TypevaliconstateerrorenabledProps> = ({ className }) => {
  return <IconSvg className={`typevaliconstateerrorenabled ${className || ''}`} />;
};
