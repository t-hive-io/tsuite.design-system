 ...
 */
export const Property1safetygapbetweenvehicles: React.FC<Property1safetygapbetweenvehiclesProps> = ({ className }) => {
  return <IconSvg className={`property1safetygapbetweenvehicles ${className || ''}`} />;
};
