 ...
 */
export const Property1level4foldedstatefocused: React.FC<Property1level4foldedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level4foldedstatefocused ${className || ''}`} />;
};
