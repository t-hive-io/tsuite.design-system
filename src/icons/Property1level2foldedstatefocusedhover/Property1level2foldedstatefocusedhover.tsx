 ...
 */
export const Property1level2foldedstatefocusedhover: React.FC<Property1level2foldedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level2foldedstatefocusedhover ${className || ''}`} />;
};
