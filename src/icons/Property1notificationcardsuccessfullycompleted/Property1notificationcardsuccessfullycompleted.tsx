 ...
 */
export const Property1notificationcardsuccessfullycompleted: React.FC<Property1notificationcardsuccessfullycompletedProps> = ({ className }) => {
  return <IconSvg className={`property1notificationcardsuccessfullycompleted ${className || ''}`} />;
};
