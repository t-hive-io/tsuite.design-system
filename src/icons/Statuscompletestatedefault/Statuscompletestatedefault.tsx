 ...
 */
export const Statuscompletestatedefault: React.FC<StatuscompletestatedefaultProps> = ({ className }) => {
  return <IconSvg className={`statuscompletestatedefault ${className || ''}`} />;
};
