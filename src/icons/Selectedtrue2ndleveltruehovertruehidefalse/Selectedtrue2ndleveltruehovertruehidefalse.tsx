 ...
 */
export const Selectedtrue2ndleveltruehovertruehidefalse: React.FC<Selectedtrue2ndleveltruehovertruehidefalseProps> = ({ className }) => {
  return <IconSvg className={`selectedtrue2ndleveltruehovertruehidefalse ${className || ''}`} />;
};
