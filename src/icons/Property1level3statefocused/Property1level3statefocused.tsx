 ...
 */
export const Property1level3statefocused: React.FC<Property1level3statefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level3statefocused ${className || ''}`} />;
};
