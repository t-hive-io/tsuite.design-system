 ...
 */
export const Property1level4stateenabled: React.FC<Property1level4stateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level4stateenabled ${className || ''}`} />;
};
