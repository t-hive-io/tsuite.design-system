 ...
 */
export const Property1level2foldedstateenabled: React.FC<Property1level2foldedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level2foldedstateenabled ${className || ''}`} />;
};
