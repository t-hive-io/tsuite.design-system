 ...
 */
export const Property1level2expandedstateenabled: React.FC<Property1level2expandedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level2expandedstateenabled ${className || ''}`} />;
};
