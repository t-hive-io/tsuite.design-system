 ...
 */
export const Property1reflectorcylinder: React.FC<Property1reflectorcylinderProps> = ({ className }) => {
  return <IconSvg className={`property1reflectorcylinder ${className || ''}`} />;
};
