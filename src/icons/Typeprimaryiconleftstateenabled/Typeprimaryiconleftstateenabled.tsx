 ...
 */
export const Typeprimaryiconleftstateenabled: React.FC<TypeprimaryiconleftstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconleftstateenabled ${className || ''}`} />;
};
