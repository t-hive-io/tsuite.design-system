 ...
 */
export const Property1level4statefocusedhover: React.FC<Property1level4statefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level4statefocusedhover ${className || ''}`} />;
};
