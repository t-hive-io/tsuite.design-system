 ...
 */
export const Property1level3expandedstateenabled: React.FC<Property1level3expandedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level3expandedstateenabled ${className || ''}`} />;
};
