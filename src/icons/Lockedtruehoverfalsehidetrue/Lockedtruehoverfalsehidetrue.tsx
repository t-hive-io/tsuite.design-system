 ...
 */
export const Lockedtruehoverfalsehidetrue: React.FC<LockedtruehoverfalsehidetrueProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehoverfalsehidetrue ${className || ''}`} />;
};
