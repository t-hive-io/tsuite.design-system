 ...
 */
export const Property1level1statefocused: React.FC<Property1level1statefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level1statefocused ${className || ''}`} />;
};
