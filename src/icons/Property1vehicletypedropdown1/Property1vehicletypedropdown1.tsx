 ...
 */
export const Property1vehicletypedropdown1: React.FC<Property1vehicletypedropdown1Props> = ({ className }) => {
  return <IconSvg className={`property1vehicletypedropdown1 ${className || ''}`} />;
};
