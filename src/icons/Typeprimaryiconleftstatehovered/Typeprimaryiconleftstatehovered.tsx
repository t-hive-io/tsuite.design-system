 ...
 */
export const Typeprimaryiconleftstatehovered: React.FC<TypeprimaryiconleftstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconleftstatehovered ${className || ''}`} />;
};
