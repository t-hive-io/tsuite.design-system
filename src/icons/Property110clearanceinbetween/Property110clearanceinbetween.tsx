 ...
 */
export const Property110clearanceinbetween: React.FC<Property110clearanceinbetweenProps> = ({ className }) => {
  return <IconSvg className={`property110clearanceinbetween ${className || ''}`} />;
};
