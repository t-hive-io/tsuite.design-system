 ...
 */
export const Typelinkbuttoniconnoiconstatefocused: React.FC<TypelinkbuttoniconnoiconstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typelinkbuttoniconnoiconstatefocused ${className || ''}`} />;
};
