 ...
 */
export const Property1level2expandedstatehovered: React.FC<Property1level2expandedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level2expandedstatehovered ${className || ''}`} />;
};
