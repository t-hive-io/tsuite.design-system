 ...
 */
export const Typeoutlinediconnoiconstatehovered: React.FC<TypeoutlinediconnoiconstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconnoiconstatehovered ${className || ''}`} />;
};
