 ...
 */
export const Property1vehicletypeviewer: React.FC<Property1vehicletypeviewerProps> = ({ className }) => {
  return <IconSvg className={`property1vehicletypeviewer ${className || ''}`} />;
};
