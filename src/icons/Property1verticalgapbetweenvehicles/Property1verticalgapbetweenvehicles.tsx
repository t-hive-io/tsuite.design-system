 ...
 */
export const Property1verticalgapbetweenvehicles: React.FC<Property1verticalgapbetweenvehiclesProps> = ({ className }) => {
  return <IconSvg className={`property1verticalgapbetweenvehicles ${className || ''}`} />;
};
