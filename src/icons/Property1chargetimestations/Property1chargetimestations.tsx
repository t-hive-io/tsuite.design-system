 ...
 */
export const Property1chargetimestations: React.FC<Property1chargetimestationsProps> = ({ className }) => {
  return <IconSvg className={`property1chargetimestations ${className || ''}`} />;
};
