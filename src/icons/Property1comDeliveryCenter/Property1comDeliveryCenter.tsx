 ...
 */
export const Property1comDeliveryCenter: React.FC<Property1comDeliveryCenterProps> = ({ className }) => {
  return <IconSvg className={`property1comdeliverycenter ${className || ''}`} />;
};
