 ...
 */
export const Property1manualoperationmenu: React.FC<Property1manualoperationmenuProps> = ({ className }) => {
  return <IconSvg className={`property1manualoperationmenu ${className || ''}`} />;
};
