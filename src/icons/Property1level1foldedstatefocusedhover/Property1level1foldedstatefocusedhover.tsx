 ...
 */
export const Property1level1foldedstatefocusedhover: React.FC<Property1level1foldedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level1foldedstatefocusedhover ${className || ''}`} />;
};
