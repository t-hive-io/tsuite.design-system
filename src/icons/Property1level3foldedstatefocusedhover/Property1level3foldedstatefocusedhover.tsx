 ...
 */
export const Property1level3foldedstatefocusedhover: React.FC<Property1level3foldedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level3foldedstatefocusedhover ${className || ''}`} />;
};
