 ...
 */
export const Property1level1expndedstatefocusedhover: React.FC<Property1level1expndedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level1expndedstatefocusedhover ${className || ''}`} />;
};
