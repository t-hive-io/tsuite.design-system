 ...
 */
export const Statesenabledbadgevisibleredwarning: React.FC<StatesenabledbadgevisibleredwarningProps> = ({ className }) => {
  return <IconSvg className={`statesenabledbadgevisibleredwarning ${className || ''}`} />;
};
