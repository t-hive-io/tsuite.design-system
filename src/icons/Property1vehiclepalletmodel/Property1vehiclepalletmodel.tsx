 ...
 */
export const Property1vehiclepalletmodel: React.FC<Property1vehiclepalletmodelProps> = ({ className }) => {
  return <IconSvg className={`property1vehiclepalletmodel ${className || ''}`} />;
};
