 ...
 */
export const Property1level4expandedstatefocusedhover: React.FC<Property1level4expandedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level4expandedstatefocusedhover ${className || ''}`} />;
};
