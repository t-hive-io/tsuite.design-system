 ...
 */
export const Property1level1expndedstateenabled: React.FC<Property1level1expndedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level1expndedstateenabled ${className || ''}`} />;
};
