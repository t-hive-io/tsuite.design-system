 ...
 */
export const Statusorderprofilestatedefault: React.FC<StatusorderprofilestatedefaultProps> = ({ className }) => {
  return <IconSvg className={`statusorderprofilestatedefault ${className || ''}`} />;
};
