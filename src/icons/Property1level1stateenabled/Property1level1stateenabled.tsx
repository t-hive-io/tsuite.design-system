 ...
 */
export const Property1level1stateenabled: React.FC<Property1level1stateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level1stateenabled ${className || ''}`} />;
};
