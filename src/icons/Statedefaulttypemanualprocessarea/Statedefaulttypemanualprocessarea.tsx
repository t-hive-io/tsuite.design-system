 ...
 */
export const Statedefaulttypemanualprocessarea: React.FC<StatedefaulttypemanualprocessareaProps> = ({ className }) => {
  return <IconSvg className={`statedefaulttypemanualprocessarea ${className || ''}`} />;
};
