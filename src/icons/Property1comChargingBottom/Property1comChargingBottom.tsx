 ...
 */
export const Property1comChargingBottom: React.FC<Property1comChargingBottomProps> = ({ className }) => {
  return <IconSvg className={`property1comchargingbottom ${className || ''}`} />;
};
