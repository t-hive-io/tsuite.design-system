 ...
 */
export const Typeoutlinediconleftstatepressed: React.FC<TypeoutlinediconleftstatepressedProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconleftstatepressed ${className || ''}`} />;
};
