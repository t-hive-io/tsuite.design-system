 ...
 */
export const Property1level2expandedstatefocused: React.FC<Property1level2expandedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level2expandedstatefocused ${className || ''}`} />;
};
