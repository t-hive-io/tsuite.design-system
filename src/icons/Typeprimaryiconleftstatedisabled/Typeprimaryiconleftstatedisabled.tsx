 ...
 */
export const Typeprimaryiconleftstatedisabled: React.FC<TypeprimaryiconleftstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconleftstatedisabled ${className || ''}`} />;
};
