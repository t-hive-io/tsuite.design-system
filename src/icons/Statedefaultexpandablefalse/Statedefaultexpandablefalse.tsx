 ...
 */
export const Statedefaultexpandablefalse: React.FC<StatedefaultexpandablefalseProps> = ({ className }) => {
  return <IconSvg className={`statedefaultexpandablefalse ${className || ''}`} />;
};
