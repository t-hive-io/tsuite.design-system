 ...
 */
export const Property1manualprocessareasection: React.FC<Property1manualprocessareasectionProps> = ({ className }) => {
  return <IconSvg className={`property1manualprocessareasection ${className || ''}`} />;
};
