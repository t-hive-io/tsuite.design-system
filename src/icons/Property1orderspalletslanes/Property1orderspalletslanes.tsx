 ...
 */
export const Property1orderspalletslanes: React.FC<Property1orderspalletslanesProps> = ({ className }) => {
  return <IconSvg className={`property1orderspalletslanes ${className || ''}`} />;
};
