 ...
 */
export const Typeoutlinediconleftstatefocused: React.FC<TypeoutlinediconleftstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconleftstatefocused ${className || ''}`} />;
};
