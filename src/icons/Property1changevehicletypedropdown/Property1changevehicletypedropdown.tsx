 ...
 */
export const Property1changevehicletypedropdown: React.FC<Property1changevehicletypedropdownProps> = ({ className }) => {
  return <IconSvg className={`property1changevehicletypedropdown ${className || ''}`} />;
};
