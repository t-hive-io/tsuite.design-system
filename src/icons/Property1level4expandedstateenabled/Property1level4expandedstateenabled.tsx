 ...
 */
export const Property1level4expandedstateenabled: React.FC<Property1level4expandedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level4expandedstateenabled ${className || ''}`} />;
};
