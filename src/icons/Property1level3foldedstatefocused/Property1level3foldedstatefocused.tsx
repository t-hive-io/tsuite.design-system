 ...
 */
export const Property1level3foldedstatefocused: React.FC<Property1level3foldedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level3foldedstatefocused ${className || ''}`} />;
};
