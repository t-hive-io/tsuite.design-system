 ...
 */
export const Typeoutlinediconleftstateenabled: React.FC<TypeoutlinediconleftstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconleftstateenabled ${className || ''}`} />;
};
