 ...
 */
export const Selectedtrue2ndleveltruehoverfalsehidefalse: React.FC<Selectedtrue2ndleveltruehoverfalsehidefalseProps> = ({ className }) => {
  return <IconSvg className={`selectedtrue2ndleveltruehoverfalsehidefalse ${className || ''}`} />;
};
