 ...
 */
export const Property1level3foldedstatehovered: React.FC<Property1level3foldedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level3foldedstatehovered ${className || ''}`} />;
};
