 ...
 */
export const Typeoutlinediconnoiconstatepressed: React.FC<TypeoutlinediconnoiconstatepressedProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconnoiconstatepressed ${className || ''}`} />;
};
