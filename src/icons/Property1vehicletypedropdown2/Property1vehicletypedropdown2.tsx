 ...
 */
export const Property1vehicletypedropdown2: React.FC<Property1vehicletypedropdown2Props> = ({ className }) => {
  return <IconSvg className={`property1vehicletypedropdown2 ${className || ''}`} />;
};
