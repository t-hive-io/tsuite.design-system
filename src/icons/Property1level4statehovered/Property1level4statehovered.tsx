 ...
 */
export const Property1level4statehovered: React.FC<Property1level4statehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level4statehovered ${className || ''}`} />;
};
