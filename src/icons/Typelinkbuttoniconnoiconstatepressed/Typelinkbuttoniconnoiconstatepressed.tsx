 ...
 */
export const Typelinkbuttoniconnoiconstatepressed: React.FC<TypelinkbuttoniconnoiconstatepressedProps> = ({ className }) => {
  return <IconSvg className={`typelinkbuttoniconnoiconstatepressed ${className || ''}`} />;
};
