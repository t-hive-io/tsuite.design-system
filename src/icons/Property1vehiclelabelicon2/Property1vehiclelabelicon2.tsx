 ...
 */
export const Property1vehiclelabelicon2: React.FC<Property1vehiclelabelicon2Props> = ({ className }) => {
  return <IconSvg className={`property1vehiclelabelicon2 ${className || ''}`} />;
};
