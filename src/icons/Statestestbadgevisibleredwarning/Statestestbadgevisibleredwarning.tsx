 ...
 */
export const Statestestbadgevisibleredwarning: React.FC<StatestestbadgevisibleredwarningProps> = ({ className }) => {
  return <IconSvg className={`statestestbadgevisibleredwarning ${className || ''}`} />;
};
