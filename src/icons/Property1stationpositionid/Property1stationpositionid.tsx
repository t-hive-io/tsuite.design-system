 ...
 */
export const Property1stationpositionid: React.FC<Property1stationpositionidProps> = ({ className }) => {
  return <IconSvg className={`property1stationpositionid ${className || ''}`} />;
};
