 ...
 */
export const Property1level4expandedstatehovered: React.FC<Property1level4expandedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level4expandedstatehovered ${className || ''}`} />;
};
