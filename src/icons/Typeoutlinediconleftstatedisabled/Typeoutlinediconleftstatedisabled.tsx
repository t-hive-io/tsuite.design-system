 ...
 */
export const Typeoutlinediconleftstatedisabled: React.FC<TypeoutlinediconleftstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconleftstatedisabled ${className || ''}`} />;
};
