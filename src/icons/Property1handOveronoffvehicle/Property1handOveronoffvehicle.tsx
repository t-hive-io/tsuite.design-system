 ...
 */
export const Property1handOveronoffvehicle: React.FC<Property1handOveronoffvehicleProps> = ({ className }) => {
  return <IconSvg className={`property1handoveronoffvehicle ${className || ''}`} />;
};
