 ...
 */
export const Property1reflectorproperties: React.FC<Property1reflectorpropertiesProps> = ({ className }) => {
  return <IconSvg className={`property1reflectorproperties ${className || ''}`} />;
};
