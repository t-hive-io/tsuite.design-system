 ...
 */
export const Typeiconvalunitstateerrorfocusandhover: React.FC<TypeiconvalunitstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstateerrorfocusandhover ${className || ''}`} />;
};
