 ...
 */
export const Property1visualizationjobs: React.FC<Property1visualizationjobsProps> = ({ className }) => {
  return <IconSvg className={`property1visualizationjobs ${className || ''}`} />;
};
