 ...
 */
export const Typeiconvalunitstateenabled: React.FC<TypeiconvalunitstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstateenabled ${className || ''}`} />;
};
