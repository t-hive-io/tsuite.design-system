 ...
 */
export const Typeprimaryiconnoiconstatehovered: React.FC<TypeprimaryiconnoiconstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconnoiconstatehovered ${className || ''}`} />;
};
