 ...
 */
export const Property1level4foldedstatefocusedhover: React.FC<Property1level4foldedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level4foldedstatefocusedhover ${className || ''}`} />;
};
