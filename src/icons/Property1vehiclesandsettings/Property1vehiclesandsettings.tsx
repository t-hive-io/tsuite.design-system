 ...
 */
export const Property1vehiclesandsettings: React.FC<Property1vehiclesandsettingsProps> = ({ className }) => {
  return <IconSvg className={`property1vehiclesandsettings ${className || ''}`} />;
};
