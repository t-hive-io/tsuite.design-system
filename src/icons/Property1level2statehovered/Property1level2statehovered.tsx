 ...
 */
export const Property1level2statehovered: React.FC<Property1level2statehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level2statehovered ${className || ''}`} />;
};
