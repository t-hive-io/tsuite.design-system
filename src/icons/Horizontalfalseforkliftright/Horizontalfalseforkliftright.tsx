 ...
 */
export const Horizontalfalseforkliftright: React.FC<HorizontalfalseforkliftrightProps> = ({ className }) => {
  return <IconSvg className={`horizontalfalseforkliftright ${className || ''}`} />;
};
