 ...
 */
export const Lockedtruehovertruehidefalse: React.FC<LockedtruehovertruehidefalseProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehovertruehidefalse ${className || ''}`} />;
};
