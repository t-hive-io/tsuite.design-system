 ...
 */
export const Typeprimaryiconleftstatefocused: React.FC<TypeprimaryiconleftstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typeprimaryiconleftstatefocused ${className || ''}`} />;
};
