 ...
 */
export const Typelinkbuttoniconnoiconstatedisabled: React.FC<TypelinkbuttoniconnoiconstatedisabledProps> = ({ className }) => {
  return <IconSvg className={`typelinkbuttoniconnoiconstatedisabled ${className || ''}`} />;
};
