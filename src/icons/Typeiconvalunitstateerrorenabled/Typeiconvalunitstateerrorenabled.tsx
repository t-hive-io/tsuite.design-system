 ...
 */
export const Typeiconvalunitstateerrorenabled: React.FC<TypeiconvalunitstateerrorenabledProps> = ({ className }) => {
  return <IconSvg className={`typeiconvalunitstateerrorenabled ${className || ''}`} />;
};
