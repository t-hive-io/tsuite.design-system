 ...
 */
export const Typelinkbuttoniconnoiconstatehovered: React.FC<TypelinkbuttoniconnoiconstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`typelinkbuttoniconnoiconstatehovered ${className || ''}`} />;
};
