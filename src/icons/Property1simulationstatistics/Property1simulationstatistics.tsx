 ...
 */
export const Property1simulationstatistics: React.FC<Property1simulationstatisticsProps> = ({ className }) => {
  return <IconSvg className={`property1simulationstatistics ${className || ''}`} />;
};
