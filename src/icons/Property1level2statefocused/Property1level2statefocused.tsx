 ...
 */
export const Property1level2statefocused: React.FC<Property1level2statefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level2statefocused ${className || ''}`} />;
};
