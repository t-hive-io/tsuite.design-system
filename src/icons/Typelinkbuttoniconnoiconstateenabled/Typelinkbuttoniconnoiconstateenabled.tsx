 ...
 */
export const Typelinkbuttoniconnoiconstateenabled: React.FC<TypelinkbuttoniconnoiconstateenabledProps> = ({ className }) => {
  return <IconSvg className={`typelinkbuttoniconnoiconstateenabled ${className || ''}`} />;
};
