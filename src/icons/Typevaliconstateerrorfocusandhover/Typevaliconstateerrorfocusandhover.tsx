 ...
 */
export const Typevaliconstateerrorfocusandhover: React.FC<TypevaliconstateerrorfocusandhoverProps> = ({ className }) => {
  return <IconSvg className={`typevaliconstateerrorfocusandhover ${className || ''}`} />;
};
