 ...
 */
export const Property1level2stateenabled: React.FC<Property1level2stateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level2stateenabled ${className || ''}`} />;
};
