 ...
 */
export const Typevalunitstateerrorenabled: React.FC<TypevalunitstateerrorenabledProps> = ({ className }) => {
  return <IconSvg className={`typevalunitstateerrorenabled ${className || ''}`} />;
};
