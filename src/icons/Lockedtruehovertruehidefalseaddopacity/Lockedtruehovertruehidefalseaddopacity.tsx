 ...
 */
export const Lockedtruehovertruehidefalseaddopacity: React.FC<LockedtruehovertruehidefalseaddopacityProps> = ({ className }) => {
  return <IconSvg className={`lockedtruehovertruehidefalseaddopacity ${className || ''}`} />;
};
