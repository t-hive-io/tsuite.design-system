 ...
 */
export const Arrowbottomrightshortcutkeylighttrue: React.FC<ArrowbottomrightshortcutkeylighttrueProps> = ({ className }) => {
  return <IconSvg className={`arrowbottomrightshortcutkeylighttrue ${className || ''}`} />;
};
