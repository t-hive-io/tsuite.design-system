 ...
 */
export const Property1automaticvalidation: React.FC<Property1automaticvalidationProps> = ({ className }) => {
  return <IconSvg className={`property1automaticvalidation ${className || ''}`} />;
};
