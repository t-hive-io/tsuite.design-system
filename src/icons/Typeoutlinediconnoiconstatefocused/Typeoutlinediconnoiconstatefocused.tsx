 ...
 */
export const Typeoutlinediconnoiconstatefocused: React.FC<TypeoutlinediconnoiconstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`typeoutlinediconnoiconstatefocused ${className || ''}`} />;
};
