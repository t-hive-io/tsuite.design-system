 ...
 */
export const Property1dimensioniconlabelx1: React.FC<Property1dimensioniconlabelx1Props> = ({ className }) => {
  return <IconSvg className={`property1dimensioniconlabelx1 ${className || ''}`} />;
};
