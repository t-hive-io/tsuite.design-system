 ...
 */
export const Property1level2expandedstatefocusedhover: React.FC<Property1level2expandedstatefocusedhoverProps> = ({ className }) => {
  return <IconSvg className={`property1level2expandedstatefocusedhover ${className || ''}`} />;
};
