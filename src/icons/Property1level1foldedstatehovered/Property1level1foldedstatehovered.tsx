 ...
 */
export const Property1level1foldedstatehovered: React.FC<Property1level1foldedstatehoveredProps> = ({ className }) => {
  return <IconSvg className={`property1level1foldedstatehovered ${className || ''}`} />;
};
