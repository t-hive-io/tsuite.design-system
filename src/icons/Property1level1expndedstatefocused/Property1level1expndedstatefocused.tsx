 ...
 */
export const Property1level1expndedstatefocused: React.FC<Property1level1expndedstatefocusedProps> = ({ className }) => {
  return <IconSvg className={`property1level1expndedstatefocused ${className || ''}`} />;
};
