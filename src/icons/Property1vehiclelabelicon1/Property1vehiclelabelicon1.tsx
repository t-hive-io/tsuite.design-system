 ...
 */
export const Property1vehiclelabelicon1: React.FC<Property1vehiclelabelicon1Props> = ({ className }) => {
  return <IconSvg className={`property1vehiclelabelicon1 ${className || ''}`} />;
};
