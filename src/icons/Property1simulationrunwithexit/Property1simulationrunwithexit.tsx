 ...
 */
export const Property1simulationrunwithexit: React.FC<Property1simulationrunwithexitProps> = ({ className }) => {
  return <IconSvg className={`property1simulationrunwithexit ${className || ''}`} />;
};
