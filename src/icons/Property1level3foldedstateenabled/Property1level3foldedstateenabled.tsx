 ...
 */
export const Property1level3foldedstateenabled: React.FC<Property1level3foldedstateenabledProps> = ({ className }) => {
  return <IconSvg className={`property1level3foldedstateenabled ${className || ''}`} />;
};
