...
const LogotypePlaceholder = () => (
  <div style={{ padding: '2rem', fontFamily: 'system-ui' }}>
    ...
    <ul style={{ lineHeight: '1.8', marginBottom: '2rem' }}>
      <li><strong>Favicon</strong> (4 variants) - 65×152px</li>
      <li><strong>XS-logo</strong> (3 variants) - 80×230px</li>
      <li><strong>Small-logo</strong> (3 variants) - 163×484px</li>
      <li><strong>Full-logo-vector</strong> (4 variants) - 105×191px</li>
      <li><strong>nav</strong> (4 variants) - 60×196px</li>
      <li><strong>Logotype complete set</strong> (12 variants) - 1622×1276px</li>
    </ul>
