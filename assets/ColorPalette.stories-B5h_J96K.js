...
Browse all colors below and copy the hex values directly.`}}}},m=()=>{const a=Object.entries(d.colors),e=a.filter(([t])=>t.startsWith("Brand Color")).length,l=a.filter(([t])=>t.startsWith("Primary Color")).length,O=a.filter(([t])=>t.startsWith("Feedback")).length,W=a.filter(([t])=>t.startsWith("Neutral")).length;return o("div",{children:[r("h2",{children:"Colors"}),o("p",{children:["Total colors synced from Figma: ",a.length]}),o("ul",{children:[o("li",{children:["Brand: ",e]}),o("li",{children:["Primary: ",l]}),o("li",{children:["Feedback: ",O]}),o("li",{children:["Neutral: ",W]})]}),o("p",{children:["Use the stories below to browse each category. These categories are derived from token naming in ",r("code",{children:"tokens/figma-tokens.json"}),"."]})]})},p=({name:a,value:e,styleId:l})=>o("div",{style:{display:"flex",flexDirection:"column",gap:"8px",padding:"16px",border:"1px solid #e0e0e0",borderRadius:"8px",backgroundColor:"white"},children:[r("div",{style:{width:"100%",height:"80px",borderRadius:"4px",backgroundColor:e,border:"1px solid #ccc"}}),r("div",{style:{fontSize:"12px",fontWeight:"600"},children:a}),r("div",{style:{fontSize:"11px",color:"#666",fontFamily:"monospace"},children:e}),o("div",{style:{fontSize:"10px",color:"#999",fontFamily:"monospace"},children:["ID: ",l.substring(0,8),"..."]})]}),c=()=>{const a=Object.entries(d.colors).filter(([e])=>e.startsWith("Brand Color"));return o("div",{children:[r("h2",{children:"Brand Colors"}),o("p",{children:["Total: ",a.length," colors"]}),r("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))",gap:"16px",marginTop:"24px"},children:a.map(([e,l])=>r(p,{name:e,value:l.value,styleId:l.figmaStyleId},e))})]})};c.storyName="Brand colors";const i=()=>{const a=Object.entries(d.colors).filter(([e])=>e.startsWith("Primary Color"));return o("div",{children:[r("h2",{children:"Primary Colors"}),o("p",{children:["Total: ",a.length," colors"]}),r("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))",gap:"16px",marginTop:"24px"},children:a.map(([e,l])=>r(p,{name:e,value:l.value,styleId:l.figmaStyleId},e))})]})};i.storyName="Primary colors";const n=()=>{const a=Object.entries(d.colors).filter(([e])=>e.startsWith("Feedback"));return o("div",{children:[r("h2",{children:"Feedback Colors"}),r("p",{children:"Used for warnings, errors, success states"}),o("p",{children:["Total: ",a.length," colors"]}),r("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))",gap:"16px",marginTop:"24px"},children:a.map(([e,l])=>r(p,{name:e,value:l.value,styleId:l.figmaStyleId},e))})]})};n.storyName="Feedback colors";const s=()=>{const a=Object.entries(d.colors).filter(([e])=>e.startsWith("Neutral"));return o("div",{children:[r("h2",{children:"Neutral Colors"}),o("p",{children:["Total: ",a.length," colors"]}),r("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))",gap:"16px",marginTop:"24px"},children:a.map(([e,l])=>r(p,{name:e,value:l.value,styleId:l.figmaStyleId},e))})]})};s.storyName="Neutral colors";const f=()=>{const a=Object.entries(d.colors);return o("div",{children:[r("h2",{children:"All T-Suite Colors"}),o("p",{children:["Complete color palette - ",a.length," total colors synced from Figma"]}),r("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(180px, 1fr))",gap:"12px",marginTop:"24px"},children:a.map(([e,l])=>r(p,{name:e,value:l.value,styleId:l.figmaStyleId},e))})]})};f.storyName="All colors";var y,u,b;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
...
}`,...(b=(u=m.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var g,v,h;c.parameters={...c.parameters,docs:{...(g=c.parameters)==null?void 0:g.docs,source:{originalSource:`() => {
...
}`,...(h=(v=c.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var C,S,I;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`() => {
...
}`,...(I=(S=i.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};var k,x,B;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`() => {
...
}`,...(B=(x=n.parameters)==null?void 0:x.docs)==null?void 0:B.source}}};var T,N,P;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`() => {
...
}`,...(P=(N=s.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};var A,F,w;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:`() => {
  const allColors = Object.entries(colors.colors);
  return <div>
...
}`,...(w=(F=f.parameters)==null?void 0:F.docs)==null?void 0:w.source}}};const L=["Overview","BrandColors","PrimaryColors","FeedbackColors","NeutralColors","AllColors"];export{f as AllColors,c as BrandColors,n as FeedbackColors,s as NeutralColors,m as Overview,i as PrimaryColors,L as __namedExportsOrder,V as default};
